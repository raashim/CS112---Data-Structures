...
public class ForgeStormBreaker {
	public static void main (String [] args) {
        ...
        int numRows = StdIn.readInt(); //read number of rows
        int numCol = StdIn.readInt(); //read number of columns
        int [][] arr = new int[numRows][numCol]; //create a new 2d array
      
        //populate the 2d array with the input array values
