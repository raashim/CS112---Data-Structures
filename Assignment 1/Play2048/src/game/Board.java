...
public class Board {
    ...
    public void addRandomTile() {
        // WRITE YOUR CODE HERE
        int randomNumber1 = StdRandom.uniform(0, openSpaces.size()); 
        BoardSpot tile = openSpaces.get(randomNumber1);
        int row = tile.getRow(); 
        int col = tile.getCol(); 
        
        double randomNum = StdRandom.uniform(0.0, 1.0); 
        int v;
